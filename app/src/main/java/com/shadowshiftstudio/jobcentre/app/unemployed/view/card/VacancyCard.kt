package com.shadowshiftstudio.jobcentre.app.unemployed.view.card
...
@Composable
fun VacancyCard(vacancy: GetJobVacancyResponse, navController: NavController, viewModel: HomeViewModel) {
            ...
            Button(
                onClick = {
                    coroutineScope.launch {
                        viewModel.applyVacancy(vacancy.jobVacancy.id)
                    }
                },
